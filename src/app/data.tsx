...
export const cardAData = [
  {
    id: 0,
    img: "assets/artificial-intelligence.svg",
    header: "MakeAI-assisted Content Choices",
  ...
  },
  {
    ...
    header: "Upload and Maintain your Brand Identity",
  ...
  },
  {
    ...
    header: "Be informed as we create",
...
export const textSectionData = [
  {
    id: 0,
    header: "Transform your Creation Process",
  ...
  {
    id: 1,
    header: "Activate your business growth with RetinkContent. ",
...
export const CardBdata = [
  {
    id: 0,
    img: "assets/logos.svg",
    header: "Logos",
